    ...
    <div class="home-main">
        ...
        <Row :gutter="10">
            ...
            <Row :style="{border: '1px solid #ddd', borderRadius: '5px', backgroundColor: 'whitesmoke'}">
                ...
                <Col :xs="24" :sm="6" :md="6" :style="{marginBottom: '10px', marginTop: '10px'}">
                <DatePicker id="datepicker" type="daterange" :options="dateoptions" placeholder="Select date" style="width: 200px" v-model="daterange1"
            ...
            <Row :gutter="5" :style="{marginTop: '10px'}">
                ...
                <infor-card id-name="totalInv_count" :end-val="count.totalInv" iconType="ios-calendar-outline" color="#E7A6C9" intro-text="Total Invoices"></infor-card>
                </Col>
                <Col :xs="24" :sm="12" :md="5" :style="{marginBottom: '10px'}">
                <infor-card id-name="total_count" :end-val="count.total" iconType="social-usd" color="#2d8cf0" intro-text="Total Amount"></infor-card>
                </Col>
                <Col :xs="24" :sm="12" :md="5" :style="{marginBottom: '10px'}">
                <infor-card id-name="paid_count" :end-val="count.paid" iconType="social-usd" color="#64d572" intro-text="Paid Amount"></infor-card>
                </Col>
                <Col :xs="24" :sm="12" :md="5" :style="{marginBottom: '10px'}">
                <infor-card id-name="unpaid_count" :end-val="count.unpaid" iconType="social-usd" color="#ffd572" intro-text="Unpaid Amount"></infor-card>
                </Col>
                <Col :xs="24" :sm="12" :md="5" :style="{marginBottom: '10px'}">
                <infor-card id-name="draft_count" :end-val="count.draft" iconType="social-usd" color="#f25e43" intro-text="Draft Amount"></infor-card>
                </Col>
            </Row>
            </Col>
        </Row>
