                                            ...
                                            <table class="info" style="width:100%;table-layout: auto;margin-top: -1px;">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="estimate-detail">
                                                            <div class="estimate-tag-block" v-for="(element, index) in row.imprint" style="text-align: left;">
                                                                ...
                                                                <div class="estimate-row" v-if="element.no_of_color">
                                                                    How many colours :
                                                                    <span>{{element.no_of_color}} Colour </span>
                                                                </div>
                                                                <div v-else>
                                                                    <br>
                                                                </div>
                                                        ...
                                                        <td style="width:15%">
                                                            <span v-if="row.charges">{{Object.keys(row.charges)[0]}}-{{row.charges.setup_charge |
                                                                upper}}
                                                            </span>
                                                            <span v-else> N/A </span>
                                                        </td>
                                                        <td style="width:8%">
                                                            <span v-if="row.charges">{{ accounting(row.charges.setup_charge)}}</span>
                                                            <span v-else> N/A </span>
                                                        </td>
                                                    </tr>
                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <span style="float: left"> {{i.shipping_address.city}} - {{i.shipping_address.postalcode}}</span>
                                                                            <br>
                                                                            <span style="float: left"> {{i.shipping_address.state}} </span>
                                                                            <br>
                                                                            <span style="float: left"> {{i.shipping_address.country}} </span>
                                                                        </td>
                                                                        <td style="width:20%">
                                                                            <span style="float: left">Shipping Type: </span>
                                                                            <span style="float: left">{{row.shipping_method.shipping_type}}</span>
                                                                            <br>
                                                                            <span style="float: left">Shipping Carrier: </span>
                                                                            <span style="float: left" v-if="i.shipping_detail.shipping_carrier">{{i.shipping_detail.shipping_carrier}}</span>
                                                                            <span v-else> - </span>
                                                                            <br>
                                                                            <span style="float: left">Method: </span>
                                                                            <span style="float: left" v-if="i.shipping_detail.shipping_method">
                                                                                {{i.shipping_detail.shipping_method}}</span>
                                                                            <span v-else> - </span>
                                                                            <br>
                                                                            <span style="float: left">In Hand Date : </span>
                                                                            <span style="float: left;color: #404040" v-if="i.shipping_detail.on_hand_date"> {{i.shipping_detail.on_hand_date}} </span>
                                                                            <span v-else> - </span>
                                                                        </td>
                                                                        <td style="width:16%">
                                                                            Charge :
