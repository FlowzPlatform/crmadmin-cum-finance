<template>
    <div class="table-box" style="text-align: -webkit-center;font-size:10px;font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif;">
        ...
        <Tabs type="card" @on-click="click" style="margin-top: 10px;">
            <TabPane label="Request Quote">
                <div style=" text-align: -webkit-right;">
                    <h4 class="panel-title" style="text-align:-webkit-right;display: -webkit-inline-box;    margin-left: 2%;">
                            ...
                            <form>
                                <div class="collapse-maindiv maindiv">
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <span class="glyphicon glyphicon-play collapsed" data-toggle="collapse" data-target="#uname"></span>
                                            <label>Name</label>
                                        </div>
                                    ...
                                    <div class="panel panel-default">
                                        <div class="panel-heading">
                                            <span class="glyphicon glyphicon-play collapsed" data-toggle="collapse" data-target="#prname"></span>
        ...
        <Modal v-model="modal1" title="Preview RequestQuote Details" width="45%" ok-text="Download PDF" @on-ok="download" @on-cancel="cancel">
