                          ...
                          <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                              <div class="estimate-row">
                                ...
                                <span v-if="item.shipping_detail.shipping_charge == ''">&nbsp;&nbsp;&nbsp;-</span>
                                <span v-else>{{item.shipping_detail.shipping_charge}}</span>
                              </div>
                              <div class="estimate-row">
                                <div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                              <div class="estimate-row">
                                <div>
                                  ...
                                  <span style="text-transform:capitalize">{{row.shipping_method.shipping_type}}</span>
                                </div>
                              </div>
                              <div class="estimate-row">
                                <div>
                                  <strong>Shipping Carrier : </strong>
                                  <span v-if="item.shipping_detail.shipping_carrier == ''" style="text-transform:capitalize">&nbsp;&nbsp;&nbsp;-</span>
                                  <span v-else style="text-transform:uppercase">{{item.shipping_detail.shipping_carrier}}</span>
                                </div>
                              </div>
                              <div class="estimate-row">
                                <div>
                                  <strong>Method : </strong>
                                  <span v-if="item.shipping_detail.shipping_method == ''">&nbsp;&nbsp;&nbsp;-</span>
                                  <span v-else>{{item.shipping_detail.shipping_method}}</span>
                                </div>
                              </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                              <div class="estimate-row">
                                <div>
                                  <strong>In Hand Date :</strong>
                                  <span v-if="item.shipping_detail.on_hand_date == ''">&nbsp;&nbsp;&nbsp;-</span>
                                  <span v-else>{{item.shipping_detail.on_hand_date}}</span>
                                </div>
                              </div>
                            </div>
                          </div>
...
<style scoped>
  ...
  .chat .message.me div .emailText:before {
    position: relative;
    float: right;
    content: "";
    width: 0px;
...
<style>
  ...
  #commentrequestinfo_comment textarea {
    resize: none;
  }
</style>