<template>
    <div style="text-align: center;font-size:10px;font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; ">
        <div class="drpdwn" style="text-align:center">
            ...
            <h4 class="panel-title" style="text-align:right;display: inline-block;    margin-left: 2%;">
                    ...
                    <form>
                        <div class="collapse-maindiv maindiv">
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="glyphicon glyphicon-play collapsed" data-toggle="collapse" data-target="#order"></span>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="glyphicon glyphicon-play collapsed" data-toggle="collapse" data-target="#send"></span>
                                    <label>po_Sent</label>
                                </div>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="glyphicon glyphicon-play collapsed" data-toggle="collapse" data-target="#sku"></span>
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <span class="glyphicon glyphicon-play collapsed" data-toggle="collapse" data-target="#email"></span>
                                    <label>Email</label>
                                </div>
        ...
        <Modal v-model="modal1" title="Preview Order Details" width="59%" ok-text="Download PDF" @on-ok="download" @on-cancel="cancel">
