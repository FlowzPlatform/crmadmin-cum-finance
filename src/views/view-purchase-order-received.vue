            ...
            <table class="table1">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <img :src="getImgUrl(row.product_description.default_image)" style="max-width:75px;max-height:75px" />
                        </td>
                                                                            ...
                                                                            <table class="size-quantity-table">
                                                                                ...
                                                                                <tbody>
                                                                                    <tr v-for="(item,inx) in productitem">
                                                                                        ...
                                                                                        <td>{{item}}
                                                                                            <div v-if="editIcon" style="display:inline-block;margin-left:20px">
                                                                                                <Button class="editIcon" type="text" icon="edit" @click="show(row,item,inx)"></Button>
                                                                                            </div>
                                                                                        </td>
                                                                                        <!-- <td>{{item}}
                                                                                            </td> -->
