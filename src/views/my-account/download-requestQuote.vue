<template>
  ...
  <div class="mj-container">
    <div style="margin:0 auto;max-width:600px;background:#f0f0f0">
      <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0;width:100%;background:#f0f0f0" align="center" border="0">
        <tbody>
          <tr>
            <td style="text-align:center;vertical-align:top;border:1px solid #ddd;direction:ltr;font-size:0;padding:20px 0">
                  ...
                  <tbody>
                    <tr>
                      <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0">
                        <div class="mj-column-per-30 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0" align="center">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="width:-35px">
                                          <img alt="" height="auto" src="http://www.aakronline.com/bundles/officebraincustombundletheme/AakronLineTheme/images/logo.png" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:auto" width="-35">
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                        ...
                        <div class="mj-column-per-40 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:15px;padding-right:10px" align="right">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="right" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="width:-15px">
                                          <img alt="" height="20px" src="https://i.imgur.com/rvEtDj1.png" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:20px" width="-15">
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                        ...
                        <div class="mj-column-per-30 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                          <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:15px;padding-left:0" align="left">
                                  <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;font-weight:700;line-height:22px;text-align:left">+800-353-2468</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
              ...
              <div style="margin:0 auto;max-width:600px">
                <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0;width:100%" align="center" border="0">
                  <tbody>
                    <tr>
                      <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:20px 0;padding-bottom:0;padding-left:20px;padding-right:20px">
                        <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
              ...
              <div style="margin:0 auto;max-width:600px">
                <table role="presentation" cellpadding="0" cellspacing="0" style="font-size:0;width:100%" align="center" border="0">
                  <tbody>
                    <tr>
                      <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0;padding-left:20px;padding-right:20px">
                          ...
                          <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:50%">
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tbody>
                                ...
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0" align="left">
                                ...
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{row.billing_info.city}}, {{row.billing_info.state}}, {{row.billing_info.postalcode}}</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{row.billing_info.country}}</div>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                          ...
                          <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:50%">
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tbody>
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:10px 25px" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{row.billing_info.mobile}}</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0" align="left">
                                ...
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">www.aakronline.com</div>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                    ...
                    <tr>
                      <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0;padding-left:20px;padding-right:20px">
                        <div class="mj-column-per-20 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                          <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;border-left:1px solid #ddd" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px" align="center">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="width:-40px">
                                          <!-- <img alt="" height="22px" src="./image/product.jpg" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:22px" width="-40"> -->
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                      ...
                      <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0;padding-left:20px;padding-right:20px">
                        <div class="mj-column-per-100 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                          <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;border:1px solid #ddd" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:0;padding-top:10px;padding-left:35px" align="left">
                                  <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:15px;line-height:22px;text-align:left">Product Description</div>
                                </td>
                              </tr>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0;padding-left:35px" align="left">
                                  <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{row.product_description.activeSummary}}</div>
                                </td>
                              </tr>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-bottom:0;padding-left:35px" align="left">
                                  <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:15px;line-height:22px;text-align:left">Special Instructions</div>
                                </td>
                              </tr>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0;padding-left:35px" align="left">
                                  <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{row.special_instruction}}</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                            ...
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 10px 10px 20px" align="left">
                                  <div style="cursor:auto;color:#fff;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:15px;font-weight:700;line-height:22px;text-align:left">1</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                    ...
                    <tr>
                      <td style="text-align:center;vertical-align:top;direction:ltr;font-size:0;padding:0;padding-left:20px;padding-right:20px">
                        <div class="mj-column-per-15 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                          <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;border-bottom:1px solid #ddd;border-left:1px solid #ddd" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px" align="center">
                                  <table role="presentation" cellpadding="0" cellspacing="0" style="border-collapse:collapse;border-spacing:0" align="center" border="0">
                                    <tbody>
                                      <tr>
                                        <td style="width:-43px">
                                          <img alt="" height="22px" src="https://images.officebrain.com/keyinnovation-api/web/product/color/9.jpg" style="border:none;border-radius:0;display:block;font-size:13px;outline:0;text-decoration:none;width:100%;height:22px" width="-43">
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                        ...
                        <div class="mj-column-per-65 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:100%">
                          <table role="presentation" cellpadding="0" cellspacing="0" style="background:#fff;border-bottom:1px solid #ddd;border-right:1px solid #ddd" width="100%" border="0">
                            <tbody>
                              <tr>
                                <td style="word-wrap:break-word;font-size:0;padding:10px 25px" align="left">
                                  <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:15px;line-height:22px;text-align:left">{{row.color}}</div>
                                </td>
                              </tr>
                            </tbody>
                          </table>
                          ...
                          <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:50%">
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tbody v-for="(item,index) in row.shipping_method.shipping_detail">
                                ...
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:0px 25px" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{item.shipping_address.city}}</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:0px 25px" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{item.shipping_address.state}}</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:0px 25px" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{item.shipping_address.country}}</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:0px 25px" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{item.shipping_address.postalcode}}</div>
                                  </td>
                                </tr>
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:0px 25px" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">{{item.shipping_address.phone}}</div>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
                          ...
                          <div class="mj-column-per-50 outlook-group-fix" style="vertical-align:top;display:inline-block;direction:ltr;font-size:13px;text-align:left;width:50%">
                            <table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                              <tbody v-for="(item,index) in row.shipping_method.shipping_detail">
                                ...
                                <tr>
                                  <td style="word-wrap:break-word;font-size:0;padding:10px 25px;padding-top:0" align="left">
                                    <div style="cursor:auto;color:#000;font-family:Ubuntu,Helvetica,Arial,sans-serif;font-size:13px;line-height:22px;text-align:left">Ship on my account:</div>
                                  </td>
                                </tr>
                              </tbody>
                            </table>
